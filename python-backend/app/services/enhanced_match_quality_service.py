...
from app.services.soul_compatibility_service import SoulCompatibilityService, CompatibilityScore
from app.services.advanced_soul_matching import AdvancedSoulMatchingService, AdvancedCompatibilityScore
from app.services.emotional_depth_service import EmotionalDepthService, DepthCompatibilityScore
...
class EnhancedMatchQualityService:
    ...
    def __init__(self):
        ...
        self.soul_compatibility_service = SoulCompatibilityService()
        self.advanced_matching_service = AdvancedSoulMatchingService()
        self.emotional_depth_service = EmotionalDepthService()
    ...
    def assess_comprehensive_match_quality(self, user1: User, user2: User, 
        ...
        try:
            ...
            soul_compatibility = self.soul_compatibility_service.calculate_compatibility(user1, user2, db)
            advanced_compatibility = self.advanced_matching_service.calculate_advanced_compatibility(
                user1, user2, db
            )
    ...
    def _default_enhanced_match_quality(self) -> EnhancedMatchQuality:
        ...
        default_soul = SoulCompatibilityService()._default_compatibility_score()
        default_advanced = AdvancedSoulMatchingService()._default_advanced_compatibility_score()
        default_depth = EmotionalDepthService()._default_depth_compatibility()
