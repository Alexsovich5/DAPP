...
from app.services.soul_compatibility_service import CompatibilityScore, SoulCompatibilityService
...
class AdvancedSoulMatchingService:
    ...
    def __init__(self):
        ...
        self.base_service = SoulCompatibilityService()
    ...
    def calculate_advanced_compatibility(self, user1: User, user2: User, db: Session, 
        ...
        try:
            ...
            base_score = self.base_service.calculate_compatibility(user1, user2, db)
