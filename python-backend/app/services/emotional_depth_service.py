...
class EmotionalDepthService:
    ...
    def calculate_depth_compatibility(
        ...
        try:
            ...
            vulnerability_match = self._calculate_vulnerability_compatibility(
                depth1, depth2
            )
    ...
    def _gather_user_text_data(self, user: User, db: Session) -> str:
        ...
        try:
            revelations = (
                ...
                .filter(DailyRevelation.sender_id == user.id)
    ...
    def _calculate_depth_harmony(
        self, depth1: EmotionalDepthMetrics, depth2: EmotionalDepthMetrics
    ) -> float:
        ...
        key = tuple(
            sorted([depth1.depth_level, depth2.depth_level], key=lambda x: x.value)
        )
    ...
    def _calculate_vulnerability_compatibility(
        self, depth1: EmotionalDepthMetrics, depth2: EmotionalDepthMetrics
    ) -> float:
    ...
    def _calculate_growth_compatibility(
        self, depth1: EmotionalDepthMetrics, depth2: EmotionalDepthMetrics
    ) -> float:
    ...
    def _predict_connection_potential(
        self,
        depth1: EmotionalDepthMetrics,
    ...
    def _predict_depth_growth_timeline(
        self, depth1: EmotionalDepthMetrics, depth2: EmotionalDepthMetrics
    ) -> str:
