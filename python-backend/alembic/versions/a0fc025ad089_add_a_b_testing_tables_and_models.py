...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_experiment_variants_variant_id'), 'experiment_variants', ['variant_id'], unique=True)
    ...
    op.create_index(op.f('ix_user_assignments_assignment_id'), 'user_assignments', ['assignment_id'], unique=True)
    ...
    sa.ForeignKeyConstraint(['assignment_id'], ['user_assignments.id'], ),
    sa.ForeignKeyConstraint(['experiment_id'], ['experiments.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['variant_id'], ['experiment_variants.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_experiment_events_event_id'), 'experiment_events', ['event_id'], unique=True)
    op.create_index(op.f('ix_experiment_events_id'), 'experiment_events', ['id'], unique=False)
