...
def upgrade() -> None:
    ...
    op.alter_column(
        ...
        existing_type=postgresql.ENUM(
            "pending", "accepted", "rejected", "cancelled", name="matchstatus"
        ),
        type_=sa.String(),
        nullable=True,
    )
    op.alter_column(
        "matches", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
    op.alter_column(
        "matches", "updated_at", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
    ...
    op.alter_column("profiles", "full_name", existing_type=sa.VARCHAR(), nullable=True)
    op.alter_column(
        "profiles",
        "bio",
    ...
    op.execute(
        "ALTER TABLE profiles ALTER COLUMN favorite_cuisines TYPE JSON USING favorite_cuisines::JSON"
    )
    op.alter_column(
        "profiles", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
    op.alter_column(
        "profiles", "updated_at", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "profiles", "updated_at", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    op.alter_column(
        "profiles", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    # Fix PostgreSQL type conversion back to VARCHAR
    op.execute(
        "ALTER TABLE profiles ALTER COLUMN favorite_cuisines TYPE VARCHAR USING favorite_cuisines::TEXT"
    )
    op.alter_column(
        "profiles",
        "bio",
    ...
    op.alter_column("profiles", "full_name", existing_type=sa.VARCHAR(), nullable=False)
    ...
    op.create_foreign_key(
        op.f("matches_recipient_id_fkey"), "matches", "users", ["recipient_id"], ["id"]
    )
    op.create_foreign_key(
        op.f("matches_initiator_id_fkey"), "matches", "users", ["initiator_id"], ["id"]
    )
    op.drop_index(op.f("ix_matches_id"), table_name="matches")
    op.alter_column(
        "matches", "updated_at", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    op.alter_column(
        "matches", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    op.alter_column(
        "matches",
        "status",
