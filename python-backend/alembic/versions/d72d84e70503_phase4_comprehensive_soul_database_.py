...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_revelations_connection_sender"), table_name="daily_revelations"
    )
    ...
    op.add_column(
        "soul_connections",
        sa.Column("user1_photo_consent", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "soul_connections",
        sa.Column("user2_photo_consent", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "soul_connections", sa.Column("photo_revealed_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "soul_connections",
        sa.Column("current_energy_level", sa.String(), nullable=True),
    )
    op.add_column(
        "soul_connections", sa.Column("energy_history", sa.JSON(), nullable=True)
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "personality_match_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "values_alignment_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections",
    ...
    op.add_column(
        "soul_connections",
        sa.Column(
            "emotional_resonance_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections",
        sa.Column("total_messages_exchanged", sa.Integer(), nullable=True),
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "revelation_completion_percentage",
            sa.DECIMAL(precision=5, scale=2),
            nullable=True,
        ),
    )
    ...
    op.add_column(
        "soul_connections",
        sa.Column(
            "mutual_engagement_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections", sa.Column("first_message_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("last_message_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "soul_connections",
        sa.Column("revelation_started_at", sa.DateTime(), nullable=True),
    )
    op.add_column(
        "soul_connections",
        sa.Column("stage_progression_dates", sa.JSON(), nullable=True),
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "conversation_depth_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections",
        sa.Column("emotional_openness_level", sa.Integer(), nullable=True),
    )
    op.add_column(
        "soul_connections",
        sa.Column(
    ...
    op.add_column(
        "soul_connections", sa.Column("last_activity_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("active_users_count", sa.Integer(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("is_typing_active", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("end_reason", sa.String(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("ended_by", sa.Integer(), nullable=True)
    )
    op.add_column(
        "soul_connections", sa.Column("ended_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "success_prediction_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "soul_connections", sa.Column("ml_model_version", sa.String(), nullable=True)
    )
    op.add_column(
        "soul_connections",
        sa.Column(
            "prediction_confidence", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    ...
    op.drop_index(
        op.f("ix_soul_connections_user1_status"), table_name="soul_connections"
    )
    op.drop_index(op.f("ix_soul_connections_user2"), table_name="soul_connections")
    op.drop_index(
        op.f("ix_soul_connections_user2_status"), table_name="soul_connections"
    )
    op.drop_index(
        op.f("ix_soul_connections_users_status"), table_name="soul_connections"
    )
    op.create_foreign_key(None, "soul_connections", "users", ["ended_by"], ["id"])
    op.add_column(
        "users", sa.Column("current_emotional_state", sa.String(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("preferred_animation_speed", sa.Float(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("haptic_feedback_enabled", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("reduced_motion_preference", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("dark_mode_preference", sa.Boolean(), nullable=True)
    )
    ...
    op.add_column(
        "users", sa.Column("total_revelations_shared", sa.Integer(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("total_messages_sent", sa.Integer(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("photo_sharing_consent", sa.Boolean(), nullable=True)
    )
    ...
    op.add_column(
        "users", sa.Column("push_notifications_enabled", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("email_notifications_enabled", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("revelation_reminders", sa.Boolean(), nullable=True)
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("ix_users_profile_complete"),
        "users",
        ["is_profile_complete"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_users_active_location"),
        "users",
        ["is_active", "location"],
        unique=False,
    )
    op.create_index(
        op.f("ix_users_active_age"),
        "users",
    ...
    op.create_index(
        op.f("ix_soul_connections_users_status"),
        "soul_connections",
        ["user1_id", "user2_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soul_connections_user2_status"),
        "soul_connections",
        ["user2_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soul_connections_user2"),
        "soul_connections",
        ["user2_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soul_connections_user1_status"),
        "soul_connections",
        ["user1_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soul_connections_user1"),
        "soul_connections",
        ["user1_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soul_connections_status"), "soul_connections", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_soul_connections_stage"),
        "soul_connections",
        ["connection_stage"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_messages_sender_unread"),
        "messages",
        ["sender_id", "is_read"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_messages_connection_unread"),
        "messages",
        ["connection_id", "is_read"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_messages_connection_created"),
        "messages",
    ...
    op.create_index(
        op.f("ix_matches_sender_status"),
        "matches",
        ["sender_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_matches_sender_id"), "matches", ["sender_id"], unique=False
    )
    op.create_index(
        op.f("ix_matches_receiver_status"),
        "matches",
        ["receiver_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_matches_receiver_id"), "matches", ["receiver_id"], unique=False
    )
    op.create_index(
        op.f("ix_matches_created_at"), "matches", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_revelations_sender_id"),
        "daily_revelations",
        ["sender_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_sender_day"),
        "daily_revelations",
        ["sender_id", "day_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_day_number"),
        "daily_revelations",
        ["day_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_created_at"),
        "daily_revelations",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_connection_sender"),
        "daily_revelations",
        ["connection_id", "sender_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_connection_id"),
        "daily_revelations",
        ["connection_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_revelations_connection_day"),
        "daily_revelations",
