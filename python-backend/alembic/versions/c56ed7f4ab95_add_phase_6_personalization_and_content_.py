...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_photo_moderation_logs_id"), table_name="photo_moderation_logs"
    )
    ...
    op.drop_index(
        op.f("ix_photo_reveal_requests_id"), table_name="photo_reveal_requests"
    )
    op.drop_table("photo_reveal_requests")
    op.drop_index(
        op.f("ix_compatibility_predictions_id"), table_name="compatibility_predictions"
    )
    op.drop_table("compatibility_predictions")
    op.drop_index(
        op.f("ix_algorithm_optimizations_id"), table_name="algorithm_optimizations"
    )
    ...
    op.drop_index(
        op.f("ix_photo_reveal_permissions_id"), table_name="photo_reveal_permissions"
    )
    ...
    op.drop_index(
        op.f("ix_photo_reveal_timelines_id"), table_name="photo_reveal_timelines"
    )
