...
def upgrade():
    ...
    op.add_column(
        "users",
        sa.Column(
            "emotional_onboarding_completed", sa.Boolean(), nullable=True, default=False
        ),
    )
    op.add_column(
        "users",
        sa.Column(
            "soul_profile_visibility", sa.String(), nullable=True, default="hidden"
        ),
    )
    op.add_column(
        "users",
        sa.Column(
            "emotional_depth_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "connection_stage", sa.String(), nullable=True, default="soul_discovery"
        ),
        sa.Column(
            "compatibility_score", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_soul_connections_id"), "soul_connections", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_daily_revelations_id"), "daily_revelations", ["id"], unique=False
    )
